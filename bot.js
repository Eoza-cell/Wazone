    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            if (shouldReconnect) {
                ...
                console.log("Déconnexion volontaire, suppression du dossier de session.");
                fs.rmSync(SESSION_DIR, { recursive: true, force: true });
                // Optionnel : redémarrer le processus pour obtenir un nouveau QR code au prochain lancement
                // process.exit(1);
            }
